...
function love.load()
    ...
    sounds = {
        ...
        ['pauseSound'] = love.audio.newSource('PauseSoundwav.wav', 'static'),
...
function love.keypressed(key)
    ...
    if key == 'p' then 
        ...
        gameState = 'Pause'
     elseif gameState == 'Pause' and love.keyboard.wasPressed('r') then
         gameState = 'Resume'
    end
end
...
function love.draw()
    ...
    if gameState == 'Pause' then 
        ...
        local imageWidth = pauseImage:getWidth()
        local imageHeight = pauseImage:getHeight()
        local pauseX = (VIRTUAL_WIDTH / 2 ) - (imageWidth / 2)
        local pauseY = (VIRTUAL_HEIGHT / 2 ) - (imageHeight / 2)
